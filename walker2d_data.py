...
class Walker2dImitationData:
    # Taken from https://arxiv.org/abs/2006.04418
    def __init__(self, seq_len):
        ...
        self.train_x = np.concatenate([self.train_x, self.train_times], axis=2)
        self.valid_x = np.concatenate([self.valid_x, self.valid_times], axis=2)
        self.test_x = np.concatenate([self.test_x, self.test_times], axis=2)
...
if __name__ == "__main__":
    Walker2dImitationData(seq_len=64)